...
void frame(void) {
    ...
    simgui_begin_frame({ width, height, sapp_frame_duration(), sapp_dpi_scale() });
    ...
    // call simgui_end_frame() after the last Dear ImGui call and outside a sokol-gfx draw call
    simgui_end_frame();
