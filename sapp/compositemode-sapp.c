//------------------------------------------------------------------------------
//  compositemode-sapp.c
//
//  A modified copy of the cube-sapp sample to test sapp_composite_mode.
//  NOTE: this is currently only supported on web and macOS.
//------------------------------------------------------------------------------
#include "sokol_gfx.h"
#include "sokol_app.h"
#include "sokol_log.h"
...
#include "compositemode-sapp.glsl.h"
...
#if defined(__EMSCRIPTEN__)
// load a webpage into a iframe and add below WebGL/WebGPU canvas
EM_JS(void, emsc_load_iframe, (void), {
...
sapp_desc sokol_main(int argc, char* argv[]) {
    ...
    (void)argv;
    return (sapp_desc){
        // NOTE: request premultiplied composite mode
