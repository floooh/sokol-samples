...
export const samples: SampleOptions[] = [
    ...
    { name: 'srgb', ui: 'cc', shd: true },
    { name: 'srgb-msaa', ui: 'cc', shd: true },
    { name: 'hdr', ui: 'cc', shd: true },
