...
static void init(void) {
    ...
    // a storage buffer and view which holds the particle positions and velocities,
...
int main() {
    osx_start(640, 480, 1, SG_PIXELFORMAT_DEPTH, "instancing-compute-metal", init, frame, shutdown);
}
