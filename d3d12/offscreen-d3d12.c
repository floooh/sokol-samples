...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nCmdShow) {
    ...
    while (d3d12_process_events()) {
        ...
        const vs_params_t display_vs_params = { .mvp = compute_mvp(rx, ry, d3d12_width(), d3d12_height()) };
        ...
        sg_begin_pass(&(sg_pass){ .action = default_pass_action, .swapchain = d3d12_swapchain() });
